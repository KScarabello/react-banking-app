            ...
            <div>
                ...
                <div className='accountinfocontainer'>
                    ...
                    <div>
                        ...
                        <h4>Available Balance: {this.props.user ? '$' + Math.floor((Math.random() + 1) * 1000) + '.00' : null}</h4>
                    </div>
...
function mapStateToProps(state){  //watches the status of user on store
    return {
        user: state.user
    }
}

let outputActions = {   //so we can invoke action creator
